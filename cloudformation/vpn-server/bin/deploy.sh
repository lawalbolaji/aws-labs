...
aws cloudformation create-stack --stack-name vpn --template-body \
    file:///Users/abdulrasheedlawal/software-engineering/playground/sre/cloud/aws/playground/vpn-server/server.json \
